...
|---|---:|---:|---:|---:|
| full | 1/1 (100%) | 257,907 | $0.0255 | 28.0 |
| baseline-b | 1/1 (100%) | 48,379 | $0.0059 | 14.0 |
| baseline-a | 0/1 (0%) | 2,754 | $0.0011 | 0.0 |

（这是单实例冒烟测试的真实数据，不是示意。它已经透露了一个值得追问的信号：
朴素 ReAct 在这条题目上以 1/5 的成本做到了同样的事。）
